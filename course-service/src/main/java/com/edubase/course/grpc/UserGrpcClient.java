...
public class UserGrpcClient {
    ...
    public void assertUserExists(String authUserId) {
        long parsedUserId;
        try {
            parsedUserId = Long.parseLong(authUserId);
        } catch (Exception ex) {
        ...
        try {
            UserByAuthIdResponse response = userQueryServiceBlockingStub
                    ...
                    .getUserByAuthId(UserByAuthIdRequest.newBuilder().setAuthUserId(parsedUserId).build());
