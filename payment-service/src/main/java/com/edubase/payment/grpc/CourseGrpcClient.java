...
public class CourseGrpcClient {
    ...
    public CourseCheckoutSummary getPublishedCourse(String courseId) {
        ...
        try {
            ...
            String title = response.getTitle() == null ? "" : response.getTitle().trim();
            return new CourseCheckoutSummary(courseId, title, price, currency);
